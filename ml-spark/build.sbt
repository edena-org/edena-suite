...
licenseOverrides := {
  ...
  | DepModuleInfo("com.bnd-lib", "bnd-core", "0.7.3")
  | DepModuleInfo("com.bnd-lib", "bnd-function", "0.7.3")
  | DepModuleInfo("com.bnd-lib", "bnd-math", "0.7.3")
  | DepModuleInfo("com.bnd-lib", "bnd-network", "0.7.3")
  | DepModuleInfo("com.bnd-lib", "bnd-network-guice", "0.7.3")
