...
import org.edena.ada.server.field.FieldUtil.{FieldOps, JsonFieldOps, NamedFieldType, fieldTypeOrdering}
import org.edena.ada.server.models.DataSetFormattersAndIds.FieldIdentity
import org.edena.ada.server.models.datatrans.{LinkMultiDataSetsTransformation, LinkSortedMultiDataSetsTransformation}
import org.edena.core.store.Criterion._
import org.edena.core.store.{And, AscSort, EqualsNullCriterion, NotEqualsNullCriterion}
...
class LinkSortedMultiDataSetsTransformer
  ...
  private def createLinkDataStream(
    ...
    for {
      source <- info.dsa.dataSetStore.findAsStream(
