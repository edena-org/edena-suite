package org.edena.ada.server.models.ml
...
import org.edena.json.{JavaEnumFormat, OptionFormat}
import org.edena.spark_ml.models.{ReservoirSpec => ReservoirSpecModel}
