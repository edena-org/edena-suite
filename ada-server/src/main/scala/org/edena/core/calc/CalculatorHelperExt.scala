...
import org.edena.core.calc.impl.{ArrayCalc, ArrayCalculatorTypePack}
import org.edena.core.calc.json.JsonInputConverterFactory
import org.edena.core.store.{Criterion, ReadonlyStore}
...
object CalculatorHelperExt {
  ...
  implicit class NoOptionsExecExt[C <: NoOptionsCalculatorTypePack, F](
    ...
    ) = calculatorExecutor.execJsonRepoStreamed((), (), withProjection, fields)(dataRepo, criterion)
    ...
    def execJsonRepoStreamedA_(
      ...
      implicit actorSystem: ActorSystem, materializer: Materializer
    ) = calculatorExecutor.execJsonRepoStreamedA((), (), withProjection, scalarOrArrayField, fields)(dataRepo, criterion)
  ...
  implicit class SingleFieldExecExt[C <: CalculatorTypePack](
    ...
    def execJsonRepoStreamedA_(
      ...
      implicit actorSystem: ActorSystem, materializer: Materializer
    ) = calculatorExecutor.execJsonRepoStreamedA(flowOptions, postFlowOptions, withProjection, field, field)(dataRepo, criterion)
