...
class EigenVectorsTest extends AsyncFlatSpec with AdaServerBaseContainer with Matchers with ExtraMatchers {
  ...
  private val statsService = instance[StatsService]
