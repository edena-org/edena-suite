...
class ScalarFieldTypeTest extends AnyFlatSpec with Matchers {
  ...
  "Enum field type" should "accept only enums " in {
    val enumValues: Map[Long, String] = Map(0l -> "Male", 1l -> "Female", 2l -> "Both", 3l -> "None")
    val fieldType = ftf.apply(FieldTypeSpec(FieldTypeId.Enum, false, enumValues)).asInstanceOf[FieldType[Long]]
